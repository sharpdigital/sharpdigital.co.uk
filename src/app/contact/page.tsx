            ...
            <div>
              <div className="mb-12">
                ...
                <p className="text-lg text-charcoal font-body leading-relaxed">
                  Tell us about your business challenges and transformation goals. We&apos;ll get
            ...
            <div>
              <div className="mb-12">
                ...
                <p className="text-lg text-charcoal font-body leading-relaxed mb-8">
                  We bring deep expertise, proven methodologies, and a track record of successful
              ...
              <div className="space-y-6">
                <Card className="bg-gray-50 border-gray-200">
                  ...
                  <CardContent>
                    <p className="text-base text-charcoal font-body leading-relaxed">
                      Successfully guided dozens of organizations through their digital
                ...
                <Card className="bg-gray-50 border-gray-200">
                  ...
                  <CardContent>
                    <p className="text-base text-charcoal font-body leading-relaxed">
                      We understand that every business is unique. Our solutions are customized to
